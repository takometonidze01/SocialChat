...
#ifndef SOCIALCHAT_SWIFT_H
#define SOCIALCHAT_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SocialChat",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10SocialChat11AppDelegate")
...
- (void)viewDidLoad;
- (IBAction)composeBarButtonPressed:(id _Nonnull)sender;
...
@interface ChatsTableViewController (SWIFT_EXTENSION(SocialChat)) <UISearchResultsUpdating>
...
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified emailLabelOutlet;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified passwordLabelOutlet;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified repeatPasswordLabelOutlet;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified accountLabelOutlet;
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified forgetPasswordButton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified signUpButton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified resendEmailButton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified loginButton;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified emailLineView;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified passwordLineView;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified repeatPasswordLineView;
- (void)viewDidLoad;
- (IBAction)loginButtonPressed:(id _Nonnull)sender;
- (IBAction)forgotPasswordButtonPressed:(id _Nonnull)sender;
- (IBAction)resendEmailButtonPressed:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC10SocialChat26ProfileTableViewController")
...
SWIFT_CLASS("_TtC10SocialChat11ProgressHUD")
...
SWIFT_CLASS("_TtC10SocialChat19RecentTableViewCell")
@interface RecentTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified unreadCounterBackgroundView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified unreadCounterLabel;
...
SWIFT_CLASS("_TtC10SocialChat13SceneDelegate")
...
SWIFT_CLASS("_TtC10SocialChat25StatusTableViewController")
...
SWIFT_CLASS("_TtC10SocialChat17UserTableViewCell")
...
SWIFT_CLASS("_TtC10SocialChat24UsersTableViewController")
...
@interface UsersTableViewController (SWIFT_EXTENSION(SocialChat)) <UISearchResultsUpdating>
- (void)updateSearchResultsForSearchController:(UISearchController * _Nonnull)searchController;
@end
